...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $grade = $_POST['grade'];
    $semester = $_POST['semester']; // Semester field
    $academic_year = $_POST['academic_year']; // Academic year field
    $student_id=null;
    $subject_id=null;
    ...
    try {
        ...
        //inserting the marks of student based on thier student_id & subject_id with semester
            ...
            <div class="content" style="margin-left:50px;">
                ...
                <form action="a_results.php" method="POST">
                    <div class="form-group">
                        <label for="enroll_no">Student ID Number (Enrollment Number):</label>
